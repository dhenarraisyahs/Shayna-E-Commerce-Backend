...
<script>
    jQuery(document).ready(function($) {
        ...
        // Pie chart flotPie1
        var piedata = [
            { label: "Pending", data: [[1, {{ $pie_status['pending'] }} ]], color: '#5c6bc0'},
            { label: "Gagal", data: [[1,{{ $pie_status['failed'] }}]], color: '#ef5350'},
            { label: "Sukses", data: [[1,{{ $pie_status['success'] }}]], color: '#66bb6a'}
        ];
